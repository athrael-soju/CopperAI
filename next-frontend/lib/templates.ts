const templates = {
  generic: {
    ...
    `,
    summarization: `Summarize the text in the History to better respond to the given user Prompt, by applying the following rules:
    - Generate a set of Sentences from the History. Each sentence should summarize the user prompt and the AI response and only include information that is relevant to the prompt.
    - If the History does not contain relevant information that can help respond to the prompt, the AI can still respond, but must preface it with a disclaimer in the summary.
